                ...
                if (courses[i].term == term_now) {
                    if (courses[i].day == now_day) {
                        if (todolist != undefined) {
                            ...
                            $("#today_todo_extension").append("<tr><td><h1 style=\"font-size:18.75px; font-weight: medium;\">授業</h1>" + courses[i].name + "<br>時間 ： " + timetableToTime(courses[i].time) + "<br><a href=\"" + courses[i].url + "\">この授業のページに移動する</a></td></tr>")
