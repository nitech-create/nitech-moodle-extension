let pageElements = {
  ...
  invisibleLeftNavigationOnlyVideo: document.getElementById("invisibleLeftNavigationOnlyVideo")
};
...
function setOptionsFromStorage() {
  ...
  chrome.storage.local.get("invisibleLeftNavigationOnlyVideo", function(data) {
    if (data.invisibleLeftNavigationOnlyVideo == undefined) {
      data.invisibleLeftNavigationOnlyVideo = defaultOptions.invisibleLeftNavigationOnlyVideo;
    }
...
function loadPageOptions() {
  return loadedOptions = {
    ...
    invisibleLeftNavigationOnlyVideo: pageElements.invisibleLeftNavigationOnlyVideo.checked
  };
}
